//-----------------------------------------------------------------------
// <copyright file="MainGameController.cs" company="Arblee">
//
// Copyright 2016 Arblee Inc. All Rights Reserved.
//
...
/// <summary>
/// MainGameController is responsible for the main game interaction.
/// 
/// This class also takes care of loading / save persistent data(marker), and loop closure handling.
/// </summary>
public class MainGameController : MonoBehaviour, ITangoPose, ITangoEvent, ITangoDepth
{
    /// <summary>
    ...
    /// </summary>
    private Mementos m_selectedMarker;
    ...
    public void Update()
    {
        ...
        if (Input.touchCount == 1)
        {
            ...
            else if (Physics.Raycast(cam.ScreenPointToRay(t.position), out hitInfo))
            {
                ...
                {
                    m_selectedMarker = tapped.GetComponent<Mementos>();
                }
            }
            else
            {
    ...
    private void _UpdateMarkersForLoopClosures()
    {
        ...
        {
            Mementos tempMarker = obj.GetComponent<Mementos>();
    ...
    private void _SaveMarkerToDisk()
    {
        ...
        foreach (GameObject obj in m_markerList)
        {
            ...
            temp.m_type = obj.GetComponent<Mementos>().m_type;
    ...
    private IEnumerator _WaitForDepthAndFindPlane(Vector2 touchPosition)
    {
        ...
        Mementos markerScript = newMarkObject.GetComponent<Mementos>();
