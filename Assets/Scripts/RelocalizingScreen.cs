//-----------------------------------------------------------------------
// <copyright file="RelocalizingScreen.cs" company="Arblee">
//
...
/// </summary>
public class RelocalizingScreen : MonoBehaviour, ITangoPose, ITangoLifecycle
{
    /// <summary>
    /// The overlay image of the relocalization process.
    /// </summary>
    public GameObject m_relocalizationScreen;
    ...
    public void OnTangoPoseAvailable(TangoPoseData pose)
    {
            ...
            && pose.framePair.targetFrame == TangoEnums.TangoCoordinateFrameType.TANGO_COORDINATE_FRAME_DEVICE)
        {
            ...
            {
                m_relocalizationScreen.SetActive(false);
            }
            else
            {
                m_relocalizationScreen.SetActive(true);
            }
        }
    }
