//-----------------------------------------------------------------------
// <copyright file="Mementos.cs" company="Arblee">
//
...
/// </summary>
public class Mementos : MonoBehaviour
{
    /// <summary>
    ...
    private void Awake()
    {
        ...
        m_anim.Play("ShowMemento", PlayMode.StopAll);
    }
    ...
    private void Hide()
    {
        m_anim.Play("HideMemento", PlayMode.StopAll);
    }
