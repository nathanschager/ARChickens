//-----------------------------------------------------------------------
// <copyright file="InitMenu.cs" company="Arblee">
//
...
/// </summary>
public class InitMenu : MonoBehaviour, ITangoLifecycle
{
    /// <summary>
    ...
    /// </summary>
    public MainGameController m_guiController;
    ...
    private void _PopulateList()
    {
        ...
        foreach (AreaDescription areaDescription in areaDescriptionList)
        {
            ...
            ADFListElement listElement = newElement.GetComponent<ADFListElement>();
